function starteditor(){
  var nodes = [ { name: "Get a fast, free web browser"    }, { name: "Make Chrome yours" },
          { name: "Pick up where you left off"    },{ name: "Browse faster"   },
          { name: "Search instantly"   },{ name: "Type less"   }];
...
var selected_node = null,
  ...
  var svg_texts = nodes_all.append("text")
      ...
      vis.selectAll("#Get a fast, free web browser")
         .attr("r",25)

function starteditor(){
  var nodes = [ { name: "Stress"    }, { name: "Cons" },
          { name: "Benefits"    }, { name: "Signals"   },
          { name: "Weaken the immune system"   }, { name: "Depression"    },
          { name: "Motivates us to reach goals" }, { name: "accompish work efficiently"   },
          { name: "Headaches"   }, { name: "Anxiety"    }];
